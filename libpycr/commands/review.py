...
def parse_command_line(arguments):
    ...
    parser.add_argument('score', help='the score of the review', default='0',
                        choices=Gerrit.SCORES, nargs='?')
    parser.add_argument('-m', '--message', help='the message of the review')
...
def main(arguments):
    ...
    change_id, score, message = parse_command_line(arguments)
    ...
    print Formatter.format(tokenize(change, review))
